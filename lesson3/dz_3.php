...
//*********************************************//
//function transliteration (string $templateString, $arrayTransliterations){
//    $templateStringLower = mb_strtolower ($templateString);
//    $result = "";
    //******************для слов*******************//
//    for ($i = 0; $i < strlen($templateStringLower); $i += 2) {
//        $result .= $arrayTransliterations[$templateStringLower[$i] . $templateStringLower[$i + 1]];
//    }
    //******************для фраз*******************//
//    for ($i = 0; $i < mb_strlen($templateStringLower); $i++) {
//        $result .= $arrayTransliterations[mb_substr($templateStringLower, $i, 1)];
//    }
//    return $result;
//}
